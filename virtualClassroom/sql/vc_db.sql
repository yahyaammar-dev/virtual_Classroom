...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2021 at 04:29 PM
...
--
-- Table structure for table `_teacher_classrooms`
--

CREATE TABLE `_teacher_classrooms` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `classroom_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `teacher_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Indexes for table `_teacher_classrooms`
--
ALTER TABLE `_teacher_classrooms`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `_teacher_classrooms`
--
ALTER TABLE `_teacher_classrooms`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
